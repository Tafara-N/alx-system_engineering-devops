...
"""
Script queries Reddit API and prints the top ten hot posts of a subreddit
"""
...
def add_titles(dictionary, hot_posts):
    """
    ...
    for word in title:
        for key in dictionary.keys():
            c = re.compile("^{}$".format(key),
                           re.I)
            if c.findall(word):
                dictionary[key] += 1
    hot_posts.pop(0)
    add_titles(dictionary, hot_posts)

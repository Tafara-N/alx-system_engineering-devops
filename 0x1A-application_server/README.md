...
Your web infrastructure is already serving web pages via `Nginx` that you installed in your [first web stack project](https://github.com/Tafara-N/alx-system_engineering-devops/tree/6bf8fba99ccce4cccc59179df1b877faf1e88954/0x0C-web_server). While a web server can also serve dynamic content, this task is usually given to an application server. In this project you will add this piece to your infrastructure, plug it to your `Nginx` and make is serve your Airbnb clone project.
...
- Make sure that [task #3](https://intranet.alxswe.com/tasks/1372) of your [SSH](https://github.com/Tafara-N/alx-system_engineering-devops/tree/a3252640205883f7f5fff403c25477d3983cef1f/0x0B-ssh) project is completed for web-01. The checker will connect to your servers.

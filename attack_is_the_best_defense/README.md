...
![ARP Spoofing](images/attack_is_the_best_defense.png)
...
You can download the script `user_authenticating_into_server` [here](assests/user_authenticating_into_server)
